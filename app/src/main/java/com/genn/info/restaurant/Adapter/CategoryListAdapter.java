...
public class CategoryListAdapter extends BaseAdapter {
    ...
    private List<Categorylistmodel> worldpopulationlist = null;
    private ArrayList<Categorylistmodel> arraylist;

    public CategoryListAdapter(Context context, List<Categorylistmodel> worldpopulationlist) {
        mContext = context;
        this.worldpopulationlist = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<Categorylistmodel>();
    ...
    public void filter(String charText) {
        ...
        {
            for (Categorylistmodel wp : arraylist)
            {
