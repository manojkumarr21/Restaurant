...
public class ListsearchViewAdapter extends BaseAdapter {
    ...
    private List<Listviewsearch> worldpopulationlist = null;
    private ArrayList<Listviewsearch> arraylist;

    public ListsearchViewAdapter(Context context, List<Listviewsearch> worldpopulationlist) {
        mContext = context;
        this.worldpopulationlist = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<Listviewsearch>();
    ...
    @Override
    public Listviewsearch getItem(int position) {
    ...
    public void filter(String charText) {
        ...
        {
            for (Listviewsearch wp : arraylist)
            {
