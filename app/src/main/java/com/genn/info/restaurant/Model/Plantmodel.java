        ...
        try
        {
            ...
            else
            {
                // Change below query according to your own database.
                    String query = "select * from Mas_Plant";
                Statement stmt = connect.createStatement();
                ResultSet rs = stmt.executeQuery(query);
                while (rs.next()){
                    Map<String,String> datanum=new HashMap<String,String>();
                    datanum.put("BussID",rs.getString("BussID"));
                    datanum.put("Plantname",rs.getString("Plantname"));
                    datanum.put("PlantID",rs.getString("PlantID"));
                    ...
                    datanum.put("Titlenote",rs.getString("Titlenote"));
                    datanum.put("Footernote",rs.getString("Footernote"));
